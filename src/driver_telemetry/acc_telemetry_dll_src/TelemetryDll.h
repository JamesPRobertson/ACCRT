...
extern "C" {
    ...
    CPPWIN32DLL_EXPORTS void update_physics_struct (OUT SPageFilePhysics*  ptr_phys_struct);
    CPPWIN32DLL_EXPORTS void update_graphics_struct(OUT SPageFileGraphics* ptr_grph_struct);
